	...
	<div class="main-container">
		<Row :gutter="10">
			...
			<Card class="search-container">
				<h3 slot="title">检索客户<span style="font-size: 12px;padding-left: 5px;"><span
						style="color: #4fa8f9">全国</span> > 河南</span></h3>
			...
			<Card class="ranklist-container">
				...
				<ul>
					<li><span class="ranking">1.&nbsp; </span><span class="city">郑州市</span><span
							class="rate">88.33%</span>
						<span class="ranklist-bar" :style="{width:200*0.88+'px'}"></span></li>
					<li><span class="ranking">2.&nbsp; </span><span class="city">洛阳市</span><span
							class="rate">77.33%</span>
						<span class="ranklist-bar" :style="{width:200*0.77+'px'}"></span></li>
					<li><span class="ranking">3.&nbsp; </span><span class="city">驻马店</span><span
							class="rate">66.33%</span>
						<span class="ranklist-bar" :style="{width:200*0.66+'px'}"></span></li>
					<li><span class="ranking">4.&nbsp; </span><span class="city">周口市</span><span
							class="rate">55.33%</span>
						<span class="ranklist-bar" :style="{width:200*0.55+'px'}"></span></li>
					<li><span class="ranking">5.&nbsp; </span><span class="city">商丘市</span><span
							class="rate">44.33%</span>
						<span class="ranklist-bar" :style="{width:200*0.44+'px'}"></span></li>
					<li><span class="ranking">6.&nbsp; </span><span class="city">三门峡</span><span
							class="rate">33.33%</span>
						<span class="ranklist-bar" :style="{width:200*0.33+'px'}"></span></li>
					<li><span class="ranking">7.&nbsp; </span><span class="city">新乡市</span><span
							class="rate">22.33%</span>
						<span class="ranklist-bar" :style="{width:200*0.22+'px'}"></span></li>
					<li><span class="ranking">8.&nbsp; </span><span class="city">平顶山</span><span
							class="rate">11.33%</span>
						<span class="ranklist-bar" :style="{width:200*0.11+'px'}"></span></li>
					<li><span class="ranking">9.&nbsp; </span><span class="city">郑州市</span><span
							class="rate">5.33%</span>
						<span class="ranklist-bar" :style="{width:200*0.05+'px'}"></span></li>
					<li><span class="ranking">10.&nbsp; </span><span class="city">南阳市</span><span
							class="rate">1.33%</span>
						<span class="ranklist-bar" :style="{width:200*0.01+'px'}"></span></li>
					<li><span class="ranking">11.&nbsp; </span><span class="city">漯河市</span><span
							class="rate">66.33%</span>
						<span class="ranklist-bar" :style="{width:200*0.66+'px'}"></span></li>
					<li><span class="ranking">12.&nbsp; </span><span class="city">许昌市</span><span
							class="rate">55.33%</span>
						<span class="ranklist-bar" :style="{width:200*0.55+'px'}"></span></li>
					<li><span class="ranking">13.&nbsp; </span><span class="city">焦作市</span><span
							class="rate">44.33%</span>
						<span class="ranklist-bar" :style="{width:200*0.44+'px'}"></span></li>
					<li><span class="ranking">14.&nbsp; </span><span class="city">鹤壁市</span><span
							class="rate">33.33%</span>
						<span class="ranklist-bar" :style="{width:200*0.33+'px'}"></span></li>
					<li><span class="ranking">15.&nbsp; </span><span class="city">濮阳市</span><span
							class="rate">22.33%</span>
						<span class="ranklist-bar" :style="{width:200*0.22+'px'}"></span></li>
					<li><span class="ranking">16.&nbsp; </span><span class="city">开封市</span><span
							class="rate">11.33%</span>
						<span class="ranklist-bar" :style="{width:200*0.11+'px'}"></span></li>
					<li><span class="ranking">17.&nbsp; </span><span class="city">信阳市</span><span
							class="rate">5.33%</span>
						<span class="ranklist-bar" :style="{width:200*0.05+'px'}"></span></li>
					<li><span class="ranking">18.&nbsp; </span><span class="city">安阳市</span><span
							class="rate">1.33%</span>
						<span class="ranklist-bar" :style="{width:200*0.01+'px'}"></span></li>
				</ul>
			</Card>
