...
<template>
	<Card class="relative">
		...
		<div @click="modal1 = true;drawModal1()"
		...
		<Modal v-model="modal1"
		       title="负荷曲线"
		       width="1200">
			<div id="lineModalChart1" :style="{width: 1000 + 'px', height: '543px',margin:'15px 0 0 20px'}">
                ...
                return {
                    ...
                    legend: {
                        data: [{name: '河南众企联合售电', icon: 'rect'}, {
                            name: '111111111',
                            icon: 'rect'
                        }, {name: '22222222222', icon: 'rect'}, {
                            name: 'asdasdasda',
                            icon: 'rect'
                        }, {name: 'dasfsdgdafasd', icon: 'rect'}],
                        left: 0,
                        top: 2,
                        itemWidth: 16,
                        itemHeight: 16,
