<script>
	import BidChart from '@/components/TradeManager/BidChart'
	import PreviousBidingChart from '@/components/TradeManager/PreviousBidingChart'
	export default {
	    name:'bidmanagement',
		data(){
	        return{
...
<template>
	<div class="main-container">
		...
		<div class="previous-biding-resolute data-panel">
			...
			<div class="btn-group fr"><button class="button btnSelected">导入数据</button></div>
			<table>
				<thead>
					<tr>
						<th>购方名称</th>
