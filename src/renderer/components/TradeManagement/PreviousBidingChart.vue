...
<template>
	<div class="bid-simulation relative">
		<div class="fr">
			<Button type="normal">上一月</Button>
			<Button type="primary">2017年6月</Button>
			<Button type="normal">下一月</Button>
		</div>
		<div id="bid-previous-chart" style="width: 1150px;height: 263px;"></div>
	</div>
</template>
<style>
	.bid-simulation {
